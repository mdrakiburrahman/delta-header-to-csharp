...
ClangSharpPInvokeGenerator `
    -c multi-file generate-file-scoped-namespaces generate-helper-types generate-disable-runtime-marshalling exclude-fnptr-codegen <# configuration for the generator#> `
